...
# DONE harmonize state names
# TODO Why are 2003 missing from original data?
# TODO fill in missing rows from allcott:
# DONE change source doc for allcott data
# DONE year = 2005, state = Andaman & Nicobar, req = 240, avail = 166
# DONE year = 1996, state = Arunachal Pradesh, reg = 162.9, avail = 83.9
# DONE year = 2007, state = Jammu & Kashmir, req = 11780, avail = 8362
# DONE year = 2001, state = AP, peak_demand = 8585, peak_met = 6873
