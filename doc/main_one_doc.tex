...
This is precisely the picture that emerges in tables \ref{tab:interaction_avg_pci} and \ref{tab:interaction_max_pci}. SOMETHING MORE ABOUT THE HYPOTHESIS TEST.
