...
Limiting the analysis to only plants observed a set amount of time af their initial production naturally limits the sample size - from just below 500,000 to around 20,000\footnote{Since I don't use the adjusted revenues in this analysis, I can include my full sample of factories.}. As is visible in figure \ref{fig:new_entry_sample}, some states are reduced to very few observations. While I run my analysis with the full sample plants from all states, I  repeated all the findings when using a restricted sample without the least represent states.
...
%			\label{tab:plant_entry_larger_max}
%			\input{tables/plant_entry/pci_max_larger}
%		\end{threeparttable}
%	\end{center}
%\end{table}   
...
\begin{table} 
	\begin{center}
		\begin{threeparttable}
			...
			\input{tables/plant_entry/pci_nonfloat}
			\begin{tablenotes} \footnotesize
...
\begin{table} 
	\begin{center}
		\begin{threeparttable}
			...
			\input{tables/plant_entry/electricity_nonfloat}
			\begin{tablenotes} \footnotesize
